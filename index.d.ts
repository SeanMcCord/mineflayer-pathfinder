...
export class Movements {
  ...
  public getRandomNeighborsGenerator(node: Move): Generator<Move, undefined, undefined>;
}

// this is a class, but its not exported so we use an interface
export class Move implements XYZCoordinates {
  public constructor(x: number, y: number, z: number, remainingBlocks: number, cost: number);
